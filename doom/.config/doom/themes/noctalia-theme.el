...
(let* ((bg "#1e1e2e")
      ...
      (outline-color "#7080b8")
      (outline-variant "#404f82")
      (primary "#cba6f7")
      (primary-container "#460594")
      (secondary "#fab387")
      (secondary-container "#993b00")
      (shadow "#000000")
      (surface "#1e1e2e")
      (surface-container "#2a2a41")
      (surface-container-high "#30304a")
      (surface-container-highest "#363653")
      (surface-container-low "#242437")
      (surface-container-lowest "#1e1e2e")
      (surface-variant "#28283d")
      (tertiary "#94e2d5")
      (tertiary-container "#19806f")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#94e2d5")
      (on-success "#000000")
      (success-container "#19806f")
      (on-success-container "#ffffff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#cba6f7")
      (primary-fixed-dim "#460594")
      (secondary-fixed "#fab387")
      (secondary-fixed-dim "#993b00")
      (tertiary-fixed "#94e2d5")
      (tertiary-fixed-dim "#19806f")
